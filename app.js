...
app.post('/send', (req, res)=>{
    ...
    <p> ${req.body.message}</p>`;
     ...
     let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'ompaljd@gmail.com', // generated the real user
    ...
    let mailOptions = {
        from: '"Online-Report-Website-Conatct" <ompaljd@gmail.com', // sender address
         // list of receivers
        to: 'ompaljd@gmail.com, tp042816@mail.apu.edu.my',
